...
const BLOG = {
  AUTHOR: 'yiqingxu', // 作者
  BIO: 'Ethan@NIIT', // 作者简介
  LINK: 'https://yiqingxu.noto.so/', // 网站地址
  KEYWORDS: 'Notion, NotionNext, 软件项目', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_EMAIL: 'yiqingxu@niit.edu.cn',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/yiqingxu',
  CONTACT_TELEGRAM: '',
